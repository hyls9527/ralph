...
const LoadingSpinner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 animate-fade-in">
      {phase === 'error' ? (
        <div className="text-rose-400 text-lg font-medium">
          {messages.error}
        </div>
      ) : (
        <>
          <div className="relative">
            ...
            <div
              className="absolute inset-0 w-12 h-12 rounded-full border-4 border-violet-500 border-t-transparent animate-spin-slow"
