...
export function Header(_props?: HeaderProps) {
  ...
  return (
    <header
      className={`border-b ${isLight ? 'bg-white/80 border-gray-200' : 'bg-gray-950/80 border-gray-800'} backdrop-blur sticky top-0 z-10`}
    >
      <div className="max-w-4xl mx-auto px-6 py-4 flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold">
          Ralph{' '}
          <span className="text-violet-400 font-normal text-sm">
