  ...
  return (
    <div className="mb-6 bg-gray-900/80 border border-violet-700/40 rounded-xl p-4 animate-fade-in">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={onExit} className="text-xs text-gray-500 hover:text-gray-300 transition-colors">
          退出对比
        </button>
      </div>
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-gray-700">
              <th className="text-left py-2 px-3 text-gray-500 font-medium min-w-[80px]">维度</th>
              {projects.map(p => (
          ...
          <tbody>
            <tr className="border-b border-gray-800">
              <td className="py-2 px-3 text-gray-500">总分</td>
              {projects.map(p => (
            ...
            <tr>
              <td className="py-2 px-3 text-gray-500">推荐指数</td>
              {projects.map(p => (
                <td key={p.repo.fullName} className="py-2 px-3 text-center">
