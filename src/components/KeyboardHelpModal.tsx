...
export function KeyboardHelpModal() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="keyboard-help-title" className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">
...
function formatShortcut(config: Omit<import('../types/shortcuts').ShortcutConfig, 'action' | 'when'>): string {
